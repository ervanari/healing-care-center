    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 p-4">
            <div className="bg-white rounded-xl shadow-lg max-w-3xl w-full">
                <div className="px-6 py-4 md:px-12 md:py-8 text-left">
                    <p className="inter-14-400-alt md:inter-16-400-alt text-black">
                        Layanan Darurat
                    ...
                    {type === "emergency" ? (
                        <>
                            <h3 className="text-3xl font-semibold text-black mt-4">
                                ...
                                <span className="text-[#03799A]">
                                    <a href="tel:119" rel="noopener noreferrer" target="_blank" className="no-underline"> 119 ext. 8 </a>
                                </span>
                            </h3>
                            <p className="mt-4 text-2xl text-black mb-9">
                        ...
                        <>
                            <h3 className="text-3xl font-semibold text-black mt-4">
                                Anda akan terhubung dengan layanan darurat bunuh diri
                                <span className="text-[#03799A]">
                                    <a href="tel:119" rel="noopener noreferrer" target="_blank"
                                       className="no-underline"> 119 ext. 8 </a>
                                </span>
                            </h3>
                            <p className="mt-4 text-2xl text-black mb-9">
                                Konseling jika Anda mengalami gejala kecemasan, putus asa, rendah diri, hampa, dan tidak
